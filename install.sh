...
clear
echo -e "gixtuh's hyprland dotfiles install wizard :P\n----------------------------------------------"
echo "install dependencies? (cava fastfetch waybar hyprland hyprlock kitty swww python-pywal btop dolphin) (y/n)"
read DEPENDENCIES
clear
echo -e "gixtuh's hyprland dotfiles install wizard :P\n----------------------------------------------"
...
case "$DEPENDENCIES" in
    y|yes|"")
        sudo pacman -S --noconfirm cava fastfetch waybar hyprland hyprlock kitty swww python-pywal btop dolphin
        case "$YAY" in
            y|yes|"")
                yay -S google-chrome
            ;;
